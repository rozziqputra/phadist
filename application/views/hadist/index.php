          ...
          <!-- flash data -->
            ...
            <div class="card-body">
              <div class="table-responsive table-sm">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
										<?php $no=1;?>
										<?php foreach ($hadist as $hds):?>
                    <tr>
                      <td><?=$no;?></td>
                      <td><?=$hds['judul_hadist']?></td>
                      <td><?=$hds['id_perawi']?></td>
                      <td>
                          <?=$hds['matan_hadist']?>
                          <hr>
                      ...
                      <td><?=$hds['id_kategori']?></td>
            <td>
            <a href="" class="btn btn-primary btn-icon-split btn-sm ubahSubmenu" data-toggle="modal" data-target="#newsubmenu" data-id="<?=$hds['id_hadist']?>">
													<span class="icon text-white-50">
            ...
            <a href="<?= base_url('menu/delete_sub_menu/'). $hds['id_hadist'];?>" class="btn btn-danger btn-icon-split btn-sm">
													<span class="icon text-white-50">
